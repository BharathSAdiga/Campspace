    ...
    <div className="auth-page-container" style={{ minHeight: 'calc(100vh - var(--header-height))', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem', position: 'relative' }}>
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '0.35rem', letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>Join Campspace</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
          ...
          <Link to="/login" style={{ color: '#0F172A', fontWeight: '700', textDecoration: 'underline' }}>
            Sign in
          </Link>
        </div>
      </div>
